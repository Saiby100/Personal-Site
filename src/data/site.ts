...
export interface Project {
  id: string;
  name: string;
  /** Label for the segmented selector; falls back to `name` when absent. */
  shortName?: string;
  stack: string;
  glanceBlurb: string;
  body: string[];
...
export const projects: Project[] = [
  ...
  // TODO: replace the two entries below with real projects.
  {
    ...
    glanceBlurb: 'One or two sentences on the problem, what you built and the result it produced.',
    body: [
